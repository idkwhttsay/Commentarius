...
export default function CurrentWeek() {
  ...
  <View style={styles.container}>
    <View style={styles.container}>
      <TouchableOpacity onPress={() => {router.push('/Current/0')}}>
        <WeekDay 
          date={Sunday.getDate()}
          day={Sunday.getDay()}
    ...
    <View style={styles.container}>
    <TouchableOpacity onPress={() => {router.push('/Current/1')}}>
        <WeekDay 
            date={Monday.getDate()}
            day={Monday.getDay()}
    ...
    <View style={styles.container}>
    <TouchableOpacity onPress={() => {router.push('/Current/2')}}>
        <WeekDay 
    ...
    <View style={styles.container}>
    <TouchableOpacity onPress={() => {router.push('/Current/3')}}>
        <WeekDay 
    ...
    <View style={styles.container}>
      <TouchableOpacity onPress={() => {router.push('/Current/4')}}>
        <WeekDay 
    ...
    <View style={styles.container}>
    <TouchableOpacity onPress={() => {router.push('/Current/5')}}>
        <WeekDay 
            date={Friday.getDate()}
            day={Friday.getDay()}
    ...
    <View style={styles.container}>
      <TouchableOpacity onPress={() => {router.push('/Current/6')}}>
        <WeekDay 
